...
//       {
//         if( vectorizingMapVals )
//         _.assert( !_.mapIs( args[ d ] ), () => 'Arguments should have only single map. Incorrect argument : ' + args[ d ] );
...
//       {
//         if( vectorizingArray )
//         _.assert( !_.longIs( args[ d ] ), () => 'Arguments should have only single map. Incorrect argument : ' + args[ d ] );
//
